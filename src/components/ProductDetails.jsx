      ...
      <div className="container">
        ...
        <div className="itemDetail" key={this.props.showItem._id}>
          ...
          <div className="itemDetailRight">
            ...
            <p>
              <b>Price: {this.props.showItem.price}$</b>
            </p>
            <p>
              <b>Author Name: {this.props.showItem.authors.join()}</b>
            </p>
            <p>
              <b>Page Count: {this.props.showItem.pageCount}</b>
            </p>
            <p>
              <b>ISBN: {this.props.showItem.isbn}</b>
            </p>
            ...
            <p>
              <button
                ...
                onClick={() => {
                  this.handleAddToCart(this.props.showItem._id);
                }}
              >
                Add to Cart
              </button>
              <button
                className="waves-effect waves-light red"
                onClick={() => {
                  this.handleBuyNow(this.props.showItem._id);
                }}
              >
                Buy Now
              </button>
